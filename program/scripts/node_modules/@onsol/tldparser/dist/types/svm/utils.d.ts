 ...
 */
export declare function findOwnedNameAccountsForUser(connection: Connection, userAccount: PublicKey, parentAccount: PublicKey | undefined): Promise<{
    pubkey: PublicKey;
    data: NameRecordHeader;
}[]>;
...
export declare function getUserNfts(owner: PublicKey, connection: Connection): Promise<any[]>;
...
export declare const getOwnedDomains: (nftAddresses: string[], connection: Connection, expectedCreator: PublicKey) => Promise<string[]>;
export declare function splitDomainTld(domain: string): string[];
export declare function findMintAddress(nameAccount: PublicKey, nameHouseAccount: PublicKey): [PublicKey, number];
export declare function findRenewableMintAddress(nameAccount: PublicKey, nameHouseAccount: PublicKey, expiresAtBuffer: Buffer): [PublicKey, number];
/**
 * retrieves owner of the name account
 *
 * @param connection sol connection
 * @param nameAccountKey nameAccount to get owner of.
 */
export declare function getDomainMintAccountKey(connection: Connection, nameAccountKey: PublicKey, tldHouse: PublicKey): Promise<PublicKey | undefined>;
export declare function getMintAccountFromDomainTld(connection: Connection, domainTld: string): Promise<PublicKey | undefined>;
export declare const getMultipleMainDomainsChecked: (connection: Connection, pubkeys: string[]) => Promise<{
    pubkey: string;
    mainDomain: string | undefined;
    nameAccount: PublicKey | undefined;
}[]>;
export declare const getMainDomainChecked: (connection: Connection, pubkey: string) => Promise<{
    pubkey: string;
    mainDomain: string | undefined;
    nameAccount: PublicKey | undefined;
}>;

...
export class TldParser {
    ...
    static createParser(connection, chain) {
        switch (chain?.toLowerCase()) {
            ...
            case 'monad':
                return new TldParserEvm(connection);
            default:
     ...
     * @param tld tld to be retrieved from
     */
    async getParsedAllUserDomainsFromTld(userAccount, tld, concurrency = 10) {
        throw new Error('Method not implemented.');
    }
    /**
    ...
    /**
     * Get multiple records for a domain (batched).
     *
     ...
     */
    async getMainDomains(_addresses) {
        throw new Error('Method not implemented.');
    }
}
